...
describe Puppet::Type.type(:set) do
  ...
  describe "when validating values" do
    describe "for name" do
      ...
      it "should not support spaces" do
        expect { described_class.new(:name => 'test attribute', :ensure => :present, :value => 'value') }.to raise_error(Puppet::Error, /test attribute is not a valid set attribute-name./)
      end
    end
