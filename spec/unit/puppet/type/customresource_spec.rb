...
describe Puppet::Type.type(:customresource) do
  ...
  describe "when validating attributes" do
    [:name, :restype, :factoryclass, :properties, :portbase, :asadminuser, :passwordfile, :user].each do |param|
  ...
  describe "when validating values" do
    ...
    # TODO: Add tests for restype, factoryclass and properties
  ...
  describe "when autorequiring" do     
    describe "user autorequire" do
      ...
      it "should not autorequire a user when no matching user can be found" do
        catalog.add_resource customresource
        customresource.autorequire.should be_empty
      end
  
      it "should autorequire a matching user" do
        catalog.add_resource customresource
        catalog.add_resource user
        reqs = customresource.autorequire
        reqs.size.should == 1
        reqs[0].source.ref.should == user.ref
        reqs[0].target.ref.should == customresource.ref
      end
    end
